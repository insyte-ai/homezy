...
import { getMyProfile, updateMyProfile } from '@/lib/services/professional';
          ...
          {activeTab === 'availability' && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <p className="text-gray-600 mb-6">
                Advanced availability calendar coming soon. For now, update your typical
                response time in your profile.
              </p>
              <Link
